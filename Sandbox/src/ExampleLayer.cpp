...
void ExampleLayer::OnUpdate(Vortex::Timestep ts)
{
    // Update
    ...
    textureShader->Bind();
    textureShader->SetFloat4("u_Color", { 1.0f, 1.0f, 1.0f, 0.5f });

    m_Texture->Bind();
    Vortex::Renderer::Submit(textureShader, m_SquareVA, glm::scale(glm::mat4(1.0f), glm::vec3(1.5f)));
    m_ChernoLogoTexture->Bind();
    Vortex::Renderer::Submit(textureShader, m_SquareVA, glm::scale(glm::mat4(1.0f), glm::vec3(1.5f))/* * glm::translate(glm::mat4(1.0f), glm::vec3(0.5f, 0.5f, 0.f))*/);
...
void ExampleLayer::OnEvent(Vortex::Event& e)
{
